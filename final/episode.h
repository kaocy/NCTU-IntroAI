...
public:
    ...
    TupleTrainingPlayer& take_turns(TupleTrainingPlayer& play1, TupleTrainingPlayer& play2) {
        ep_time = millisec();
        return (turn_count++ % 2) ? play2 : play1;
    }

    TupleTrainingPlayer& last_turns(TupleTrainingPlayer& play1, TupleTrainingPlayer& play2) {
